...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // If the 3 variables we pass are all included in our array then true is
...
// This function takes a string parameter of the path you set earlier for placement
//sound('./media/place.mp3')
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            // This condition is similar to the one above. This is necessary for
            //the 6, 4, 2 win condition.
            if (x >= x2 && y >= y2) { cancelAnimationFrame(animationLoop); }
        }
        // This condition is similar to the one above. This condition is necessary
